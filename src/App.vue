<template>
  <div>
    ...
    <div class="py-container">
      <div class="allgoods">
        <h4 class="shoptitle"><span>全部商品</span><span>11</span></h4>
        ...
        <!-- 其他 -->
        <div class="youLike">
          <div class="yk-title"><span>猜你喜欢</span>特惠换购</div>
          <div class="yk-product">
            <ul class="clearfix">
              <li>
                <div class="yk-product-top">
                  <img src="~@/assets/images/fs7805.gif" alt="" />
                </div>
                ...
                <div class="yk-product-bottom"><img src="~@/assets/images/car.gif" alt="" /> 加入购物车</div>
              </li>
              <li>
                <div class="yk-product-top">
                  <img src="~@/assets/images/fs7805.gif" alt="" />
